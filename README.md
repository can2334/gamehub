...
1# 🎓 Dijital Öğrenme Laboratuvarı: Eğitimde Oyunlaştırma
...
Klasik ezberci eğitim anlayışının dışına çıkarak; **Bilişim Teknolojileri**, **Fizik** ve diğer teknik derslerdeki ünitelerin öğrenciler için daha akılda kalıcı olmasını hedefliyoruz. Bu platform, okul müfredatına destekleyici bir dijital materyal olarak tasarlanmıştır.
...
- **Kalıcı Bilgi:** Görsel geri bildirimler ve stratejik joker kullanımıyla analitik düşünme becerisinin geliştirilmesi.

## 🚀 Öne Çıkan Özellikler

- **Dinamik Kategori Sistemi:** URL üzerinden farklı ders branşlarına (Fizik, Bilişim vb.) anlık erişim.
- **Modern Eğitim Arayüzü:** "Hacker/Tech" temalı, odaklanmayı artıran karanlık mod tasarımı.
- **Eğitsel Jokerler:** 50/50, Seyirci ve Soru Paslama gibi öğrenciyi stratejiye zorlayan mekanikler.
- **Yüksek Performans:** Cloudflare Workers Edge mimarisi sayesinde milisaniyelik veri akışı.
- **Tam Uyumluluk:** Akıllı tahtalar, tabletler ve mobil cihazlar ile kusursuz çalışma.

## 🛠️ Teknik Yığın (Tech Stack)

| Katman | Teknoloji | Açıklama |
| :--- | :--- | :--- |
| **Frontend** | `Next.js 14` | Modern App Router mimarisi. |
| **Dil** | `TypeScript` | Güvenli ve ölçeklenebilir kod yapısı. |
| **Stil** | `Tailwind CSS` | Hızlı ve özelleştirilmiş tasarım. |
| **Backend/API** | `Cloudflare Workers` | Edge Computing tabanlı soru bankası servisi. |
| **İkonlar** | `Lucide React` | Minimalist ve modern ikon seti. |
